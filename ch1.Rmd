...
somewhere, then it is *inactive*. You can say that a collider breaks any flow of information, if
...
misleading about its causal source*. This weird phenomenon can be illustrated by evaluating this (I
assume that the observations in $X$, $Y$, and $Z$ were generated by the $X \rightarrow Y \leftarrow
Z$ process):
